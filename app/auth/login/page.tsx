        ...
        <div className="max-w-lg space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Sign in to access your dashboard and continue connecting with
              amazing creative talent or exciting opportunities.
            </p>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Access your profile and dashboard immediately
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-white">Protected Data</h3>
                <p className="text-sm text-gray-400">
